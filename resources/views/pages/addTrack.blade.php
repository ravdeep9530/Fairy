                    ...
                    <form id="detail_form"  method="post" enctype="multipart/form-data" action="#">
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Track Name" id="tt" maxlength="15" required name="t_name" type="text" autofocus>
                            </div>

                            <div class="form-group">

                                <input class="form-control" placeholder="Singer Name" id="db" maxlength="15" required  name="s_name" type="text"  value="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Track Poster<small>(image width:280px Height:280px)</small>:</label>
                                <input   id="db"  name="pt_image" type="file" required  >
                            </div><div class="form-group">
                                <label>Master Track<small>(.wav)</small>:</label>
                                <input   id="db"  name="w_track" type="file" required  >
                            </div>
                            ...
                            <div class="form-group">
                                <label>Lyrics</label>
                                <textarea class="form-control" required name="lyrics" id="wtb"></textarea>
                            </div>
