                    ...
                    <form id="detail_form"  method="post" enctype="multipart/form-data" action="#">
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Video Title" id="tt" maxlength="15" required name="t_name" type="text" autofocus>
                            </div>

                            <div class="form-group">

                                <input class="form-control" placeholder="Artist Name" id="db" maxlength="15" required  name="s_name" type="text"  value="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Video Poster:<small>(width:280 height:280)</small></label>
