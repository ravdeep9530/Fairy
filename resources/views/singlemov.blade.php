                ...
                <li>
                    ...
                    <div class="date-city">
                        ...
                        <div class="buy-tickets">
                            <button  class="play-icon popup-with-zoom-anim btn btn-lg btn-success" style="background-color:rgba(142, 248, 94, 0.34); color: #0b0b0b;"  onclick="loadCall('/mov/{!! $row1->movie_id !!}')">See Now</button>
                        </div>
                    </div>
