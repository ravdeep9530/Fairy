                            ...
                            <div class="browse-inner">
                                ...
                                @foreach($rtracks as $row)
                                    <div class="col-md-3 artist-grid">
                                        <a  style="cursor: pointer;" onclick="loadCall('mov/{!! $row->movie_id !!}')"><img src="uploads/{!! $row->track_poster !!}" title="allbum-name"></a>
                                        <a style="cursor: pointer;" onclick="loadCall('mov/{!! $row->movie_id !!}')"><i class="glyphicon glyphicon-play-circle"></i></a>
                                        <a class="art" style="cursor: pointer;" onclick="loadCall('mov/{!! $row->movie_id !!}')">{!! $row->track_name!!}</a>
                                    </div>
                                @endforeach
            ...
            <ul id="flexiselDemo5">
                @foreach($rantracks as $row1)
                    ...
                    <li>
                        ...
                        <a  onclick="loadCall('/mov/{!! $row1->movie_id !!}')" ><img
                        ...
                        <div class="date-city">
                            ...
                            <div class="buy-tickets">
                                <button  class="play-icon popup-with-zoom-anim btn btn-lg btn-success" style="background-color:rgba(142, 248, 94, 0.34); color: #0b0b0b;"  onclick="loadCall('/mov/{!! $row1->movie_id !!}')">Listen Now</button>
                            </div>
                        </div>
