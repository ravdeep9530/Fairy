						...
						<div class="browse">
								...
								<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
								  <ul id="myTab" class="nav nav-tabs" role="tablist">
								   ...
								   <li role="presentation"><a href="#folk" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">Folk</a></li>
								    ...
								    <li role="presentation" class=""><a href="#dharmik" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="false">Dharmik</a></li>
								...
								@foreach($rtracks as $row)
											<div class="col-md-3 artist-grid">
												<a  style="cursor: pointer;" onclick="loadCall('single/{!! $row->track_id !!}')"><img src="uploads/{!! $row->track_poster !!}" title="allbum-name"></a>
												<a style="cursor: pointer;" onclick="loadCall('single/{!! $row->track_id !!}')"><i class="glyphicon glyphicon-play-circle"></i></a>
												<a class="art" style="cursor: pointer;" onclick="loadCall('single/{!! $row->track_id !!}')">{!! $row->track_name!!}</a>
											</div>
										@endforeach
								  ...
								  <div role="tabpanel" class="tab-pane fade active in" id="bhangra" aria-labelledby="home-tab">
									...
									<div role="tabpanel" class="tab-pane fade active in" id="jaz" aria-labelledby="home-tab">
									 <div class="browse-inner">
								  ...
								  </div><div role="tabpanel" class="tab-pane fade active in" id="dharmik" aria-labelledby="home-tab">
									 <div class="browse-inner">

										 @foreach($dhartracks as $row)
											 <div class="col-md-3 artist-grid">
												 <a  style="cursor: pointer;" onclick="loadCall('single/{!! $row->track_id !!}')"><img src="uploads/{!! $row->track_poster !!}" title="allbum-name"></a>
												 <a style="cursor: pointer;" onclick="loadCall('single/{!! $row->track_id !!}')"><i class="glyphicon glyphicon-play-circle"></i></a>
												 <a class="art" style="cursor: pointer;" onclick="loadCall('single/{!! $row->track_id !!}')">{!! $row->track_name!!}</a>
									 ...
									 @foreach($rantracks as $row1)
										 ...
										 <li>
											 ...
											 <a  onclick="loadCall('/single/{!! $row1->track_id !!}')" ><img
														 src="uploads/{{$row1->track_poster}}" alt="ddd" title="{{$row1->track_name}}"></a>
											 <div class="slide-title"><h4>{{$row1->track_name}}</h4></div>
											 <div class="date-city">
